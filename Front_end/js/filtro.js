      ...
      if(currentView === "cards") {
          ...
          <div class="task-card-item ${t.done ? "task-done" : ""}">
            <div class="task-row">
              ...
              <div class="task-actions">
                <i class="bi bi-pencil" onclick="editTask(${i})" style="font-size:1.2rem;"></i>
                <i class="bi bi-trash text-danger" onclick="deleteTask(${i})" style="font-size:1.2rem;"></i>
              </div>
            </div>
          </div>
        `;
        ...
        tableBody.innerHTML += `
          <tr class="${t.done?"task-done":""}">
            ...
            <td>
              <i class="bi bi-pencil me-2" onclick="editTask(${i})" style="font-size:1.2rem;"></i>
              <i class="bi bi-trash text-danger" onclick="deleteTask(${i})" style="font-size:1.2rem;"></i>
            </td>
          </tr>
        `;
